...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Interfaces\SearchInterface' => \App\Repositories\SearchRepository::class,
    ...
    override(\config(), map([
            ...
            'database.connections.legacy.url' => 'NULL',
            ...
            'database.connections.legacy.options' => 'array',
            ...
            'filesystems.links.M:\www\laravel\laravel_search\public\storage' => 'string',
...
'database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.legacy.driver','database.connections.legacy.url',
'database.connections.legacy.host','database.connections.legacy.port','database.connections.legacy.database','database.connections.legacy.username','database.connections.legacy.password',
'database.connections.legacy.unix_socket','database.connections.legacy.charset','database.connections.legacy.collation','database.connections.legacy.prefix','database.connections.legacy.prefix_indexes',
'database.connections.legacy.strict','database.connections.legacy.engine','database.connections.legacy.options','database.migrations.table','database.migrations.update_date_on_publish',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.M:\\www\\laravel\\laravel_search\\public\\storage',
...
'session.secure','session.http_only','session.same_site','session.partitioned','passkeys.relying_party_id',
'passkeys.allowed_origins','passkeys.user_handle_secret','passkeys.timeout','passkeys.guard','passkeys.middleware',
'passkeys.management_middleware','passkeys.throttle','passkeys.redirect','ide-helper.filename','ide-helper.models_filename',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','api.search',
'api.login','search','storage.local',
...
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array_keys','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.base64','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url',
'M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','M:.www.laravel.laravel_search.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
